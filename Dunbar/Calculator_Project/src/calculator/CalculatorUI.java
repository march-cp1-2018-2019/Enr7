...
public class CalculatorUI{
  ...
  private void calculate(){
    ...
    if(input[0].charAt(0) == '-' || input[1].charAt(0) == '-'){
      errorMessage.setText("No negative numbers allowed");
      return;
    }
    ...
    try{
      ...
      errorMessage.setText("First number is not valid");
      return;
    }
    ...
    try{
      ...
      errorMessage.setText("Second number is not valid");
      return;
    }
    ...
    try{
      ...
      if(result < 0){
        errorMessage.setText("Negative numbers are not allowed");
        return;
      }
